...
PIPEVIEW_API_PORT=8000		# internal port
PIPEVIEW_API_PORT_BASE_EXPORTED=48000
PIPEVIEW_DAYS=90
PIPEVIEW_PGPORT=5432		# native internal port
PIPEVIEW_POSTGRES_CONTAINER=pipeview-db
PIPEVIEW_POSTGRES_DB=pipeview
PIPEVIEW_POSTGRES_IMAGE=postgres:18-alpine
PIPEVIEW_POSTGRES_PORT_BASE_EXPORTED=54320
PIPEVIEW_POSTGRES_USER=postgres
...
PIPEVIEW_API_PORT_EXPORTED=$(expr $PIPEVIEW_API_PORT_BASE_EXPORTED + $PIPE_TYPE_PORT_BIAS + $PORT_BIAS)
PIPEVIEW_POSTGRES_PORT_EXPORTED=$(expr $PIPEVIEW_POSTGRES_PORT_BASE_EXPORTED + $PIPE_TYPE_PORT_BIAS + $PORT_BIAS)
...
PIPEVIEW_DATABASE_URL=postgresql+psycopg://$PIPEVIEW_POSTGRES_USER:$PIPEVIEW_POSTGRES_PASSWORD@$PIPEVIEW_POSTGRES_CONTAINER:$PIPEVIEW_PGPORT/$PIPEVIEW_POSTGRES_DB
...
echo PIPEVIEW_API_PORT_EXPORTED $PIPEVIEW_API_PORT_EXPORTED
