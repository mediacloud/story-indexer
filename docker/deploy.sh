...
ELASTICSEARCH_SNAPSHOT_LOCATION="fs"
...
prod)
    ...
    ELASTICSEARCH_SNAPSHOT_LOCATION="s3"
...
add ELASTICSEARCH_S3_ACCESS_KEY # private
add ELASTICSEARCH_S3_SECRET_KEY # private
add ELASTICSEARCH_SNAPSHOT_CRONJOB_ENABLE # NOT bool!
add ELASTICSEARCH_SNAPSHOT_LOCATION
