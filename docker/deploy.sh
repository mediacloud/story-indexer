...
staging)
    ...
    ELASTICSEARCH_SHARD_REPLICAS=1
    ELASTICSEARCH_SNAPSHOT_REPO=staging-mediacloud-elasticsearch-snapshots
...
dev)
    ...
    ELASTICSEARCH_SHARD_REPLICAS=1
    ELASTICSEARCH_SNAPSHOT_REPO=test-mediacloud-elasticsearch-snapshots
