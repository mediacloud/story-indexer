...
ELASTICSEARCH_SNAPSHOT_SETTINGS_LOCATION="/var/backups/elasticsearch"
...
add ELASTICSEARCH_SNAPSHOT_TYPE
add ELASTICSEARCH_SNAPSHOT_REPO allow-empty
add ELASTICSEARCH_SNAPSHOT_SETTINGS_LOCATION
add ELASTICSEARCH_SNAPSHOT_SETTINGS_BUCKET #private
